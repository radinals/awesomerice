...
return {
  ...
  increaseAudioVolume       =  function(n) os.execute("volumecontrol up " .. n ) end,
  decreaseAudioVolume       =  function(n) os.execute("volumecontrol down " .. n) end,
  toggleAudioMute           =  function()  os.execute("volumecontrol mute") end,
